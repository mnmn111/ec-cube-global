 ...
 * @version $Id: LC_Page_Admin_Design_MainEdit.php 22504 2013-02-05 12:02:12Z m_uehara $
 */
class LC_Page_Admin_Design_MainEdit extends LC_Page_Admin_Ex {
    ...
    function lfInitParam(&$objFormParam) {
        ...
        $objFormParam->addParam(t('c_Name_03'), 'page_name', STEXT_LEN, 'KVa', array('SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
