 ...
 * @version $Id: LC_Page_Admin_Basis_Payment.php 22509 2013-02-06 12:08:56Z kim $
 */
class LC_Page_Admin_Basis_Payment extends LC_Page_Admin_Ex {
    ...
    function action() {
        ...
        if (!empty($_POST)) {
            ...
            $objFormParam->addParam(t('c_Payment method ID_01'), 'payment_id', INT_LEN, 'n', array('NUM_CHECK', 'MAX_LENGTH_CHECK'));
